...
| フェーズ | 内容 | 成果物 |
|----------|------|--------|
| 1 | 共通型・インターフェース | core/core.hpp（EvalResult, JacobianResult, IObjective, IDifferentiableObjective） |
| 2 | 設定 CSV 仕様と ParameterMapper | param/param.hpp（ParamSpec, CsvParamLoader, ParameterMapper） |
